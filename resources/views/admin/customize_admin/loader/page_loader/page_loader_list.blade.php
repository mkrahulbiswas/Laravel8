        ...
        <div class="card-box table-responsive boder" style="border-top-left-radius: 0; border-top-right-radius: 0; margin-bottom: 0px;">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <h4 class="header-title">Customize Page Loader List</h4>
                </div>
            </div>
            ...
            <table id="customizeAdmin-pageLoader-listing" class="tableStyle table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Html</th>
