...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form id="updateCustomizeTableColorForm" action="{{route('admin.update.customizeTableColor')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group text-right m-b-0">
                    <button type="submit" id="updateCustomizeTableColorBtn"  class="btn saveBtn waves-effect waves-light"><i class=""></i> <span>Save</span></button>
                </div>
