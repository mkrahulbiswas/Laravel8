...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="btn-group pull-right m-t-15">
            <a href="{{ url('admin/roles-permissions/permissions') }}" class="btn btn-primary waves-effect waves-light"><i class=" ti-arrow-left"></i> Back</a>
        </div>
        ...
        <div class="card-box table-responsive">
            ...
            <form action="{{route('admin.update.permissions')}}" method="POST">
                ...
                <div class="form-group text-right m-b-0">
                    <button type="submit" class="btn btn-primary waves-effect waves-light" type="submit"><i class="ti-save"></i> Update</button>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{route('roles.save')}}" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light" type="submit"><i class="ti-save"></i> Save</button>
                            </div>
                        </form>
                    </div>
                </div>
