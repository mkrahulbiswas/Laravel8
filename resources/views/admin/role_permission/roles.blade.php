...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="btn-group pull-right m-t-15">
            <button type="button" data-toggle="modal" data-target="#con-add-modal" class="btn btn-primary waves-effect waves-light"><i class="ion-plus-circled"></i> Add Role</button>
        </div>
        @endif
...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            ...
            <table id="rolePermision-role-listing" class="table tableStyle table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Roles</th>
...
<div class="row">
    <div class="col-12">
        <div id="con-add-modal" data-for-page="{{ route('admin.show.roles') }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
...
<div class="row">
    <div class="col-12">
        <div id="con-edit-modal" data-for-page="{{ route('admin.show.roles') }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
...
<div class="row">
    <div class="col-12">
        <div id="con-detail-modal" data-for-page="{{ route('admin.show.roles') }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
