...
<div class="topbar">
    <div class="topbar-left">
        <div class="text-center" style="padding: 0 10px;">
            ...
            <!-- Image Logo here -->
            <a href="{{ route('dashboard.show') }}" class="logo">
                <i class="icon-c-logo">
                    {{-- <img src="" height="50" /> --}}
                    {{-- <img src="{{ session('data.smallLogo') }}" height="50" /> --}}
                    <img src="{{ $reqData['smallLogo'] }}" height="50" />
                </i>
                <span>
                    {{-- <img src="" height="50" /> --}}
                    {{-- <img src="{{ session('data.bigLogo') }}" height="50" /> --}}
                    <img src="{{ $reqData['bigLogo'] }}" height="50" />
                </span>
            </a>
        </div>
    </div>
